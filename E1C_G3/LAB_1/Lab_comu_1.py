...
class Lab_comu_1(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.analog_sig_source_x_0 = analog.sig_source_f(sample_rate, analog.GR_SIN_WAVE, frecuency, 1, 0, 0)
        self._Amplitud_range = Range(0, 5, 1, 3, 200)
