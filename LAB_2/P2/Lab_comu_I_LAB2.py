...
class Lab_comu_I_LAB2(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self._t_band_win = qtgui.RangeWidget(self._t_band_range, self.set_t_band, "Banda de transisicon", "counter_slider", float, QtCore.Qt.Horizontal)
        ...
        self.analog_sig_source_x_0 = analog.sig_source_f(samp_rate, analog.GR_COS_WAVE, fm, (2*No), 0, 0)
    ...
    def set_No(self, No):
        ...
        self.analog_sig_source_x_0.set_amplitude((2*self.No))
